				...
				<div style="background: #0099ff;">
					...
					<v-col cols="2" md="3">
							...
							<v-card-title>
								...
								<span class="text-h6 font-weight-light">Caminata</span>
							</v-card-title>

							<v-card-text class="text-h5 font-weight-bold">
								te ofrece un paisaje pintoresco, ruinas arqueológicas y las fascinantes
							</v-card-text>
							</v-card>
						</v-col>
						<v-col cols="2" md="3">
